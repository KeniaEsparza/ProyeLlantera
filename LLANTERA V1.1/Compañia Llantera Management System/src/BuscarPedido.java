...
public double IVA=0.16;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 341, 960, 230));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 450, -1, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 490, 161, -1));

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("Total:");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 360, -1, -1));

        jTextField9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(jTextField9, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 390, 130, 40));
    ...
    public boolean validarNumeros(String datos)
{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            ResultSet rsdetalle=stdetallepe.executeQuery("select * from detalle_pedido where fk_id_pedido = '"+IDpedido+"'");
            if(rsdetalle.next() && rsdetalle.last() && rsdetalle.first())
            {
           // model.addRow(new Object[]{(rsdetalle.getString(2)),(rsdetalle.getString(3)),(rsdetalle.getString(5))});
            //////////////
            Statement stdprodu=conn.createStatement();
            ResultSet rsprod=stdprodu.executeQuery("select * from producto where id_producto = '"+rsdetalle.getString(5)+"'");
            if(rsprod.next())
            {                                 //nombre         cantidad                 precio             importe    descripcion              clave
                Object [][] data = new Object[10][6];
                double mprt = 0;
                model.addRow(new Object[]{rsprod.getString(2),rsdetalle.getString(2),rsdetalle.getString(3),mprt,rsprod.getString(3),rsdetalle.getString(5)});
                for( int x=0;x<jTable1.getRowCount();x++){
                    int cntd = Integer.parseInt((String) jTable1.getValueAt(x,1));
                    double prc = Double.parseDouble((String) jTable1.getValueAt(x,2));
                    mprt = cntd * prc; 
                    double ttl=mprt+(mprt*IVA); 
                    String ttlv= String.valueOf(ttl);
                    jTextField9.setText(ttlv); 
                    jTable1.setValueAt(mprt,x,3);
                    data[x][1]=cntd;
                    data[x][2]=prc;
