...
public double IVA=0.16;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 420, -1, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 460, 161, -1));
...
public boolean validarNumeros(String datos)
{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            ResultSet rs=st.executeQuery("select * from pedido where id_pedido like '"+IDpedido+"%'");
            if(rs.next())
            {
